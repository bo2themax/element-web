...
// Keep the currently presented popover alive. Without a strong reference the
// NSPopover is deallocated as soon as the presenting scope returns and the popover
